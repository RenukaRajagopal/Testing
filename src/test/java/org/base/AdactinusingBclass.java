...
public class AdactinusingBclass extends Baseclassmethods  {
	public static void main(String[] args) {
		Baseclassmethods a=new Baseclassmethods();
		a.getDriver();
		a.implicitWait(30);
		a.getUrl("https://adactinhotelapp.com/");
		a.elementSendkeys(a.findByXpath("//input[@id='username']"), "Greens8767");
		a.elementSendkeys(a.findByID("password"), "QN8V3A");
